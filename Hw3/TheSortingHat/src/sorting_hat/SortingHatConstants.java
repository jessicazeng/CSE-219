...
public class SortingHatConstants
{
    ...
    public static final int GAME_VIEWPORT_WIDTH = 1180;
    public static final int GAME_VIEWPORT_HEIGHT = 600;
    ...
    public static final int UNDO_X = STATS_X + 160;
    ...
    public static final Font FONT_STATS = new Font(Font.MONOSPACED, Font.BOLD, 16);
}